...
> = {
  home: {
    ...
    description:
      '働きづらさを人の問題で終わらせず、仕事条件の地図として読み直すNext Being Labの入口。',
  ...
  'case-readings': {
    ...
    description:
      '相談の一言をつぶさず拾い、仕事条件の設計へつなげるアセスメントの入口。',
  ...
  'work-design-views-guide': {
    ...
    description:
      '人間の多様性を前提に、仕事と社会参加を設計し直すための実用ガイド。',
  ...
  'articles-social-questions': {
    ...
    description:
      '現場、政策、社会の問いを、仕事条件の論考として読み直すNBLレポート。',
  ...
  'toolkit-studio': {
    ...
    description:
      '図解、4コマ、音楽、フォーラム、資料を、会議や研修で使える形に並べた入口。',
  ...
  'work-condition-window': {
    ...
    description:
      '障害種類や疾病名から入り、例外的対応ではなく職場設計として読み直す入口。',
  ...
  'theory-method-trust': {
    ...
    description:
      '専門情報を安全に読み、複雑な仕事条件を人に使える形へ翻訳するNBLの専門性。',
  ...
  'about-boundary': {
    ...
    description:
      'Next Being Labの運営目的、責任者、問い合わせ、免責、著作権、SNS発信の扱い。',
    imagePath: '/images/next-nbl-home-hero-image2-v1.png',
