...
const PATTERN_CARDS: PatternCard[] = [
  ...
  },
  {
    ...
    selectionBoundary:
      '選ぶ目安: 主課題が「受診日・受診時刻」と「納期・会議枠」の衝突なら本カード。勤務制度（夜勤・連勤・早出）の不整合が中心なら「勤務時刻の不整合が主因」、始業前の移動消耗が中心なら「通勤負荷が主因」、復職初期の負荷段階設計が中心なら「復職ランプ不足が主因」を優先。',
    quickBundle: [
  ...
  },
  {
    ...
    selectionBoundary:
      '選ぶ目安: 主課題が早出/遅出/夜勤/連勤など「勤務時刻制度」と症状リズムの不整合なら本カード。受診日・受診時刻の衝突が中心なら「通院日程の衝突が主因」、日ごとの負荷配分が中心なら「体調変動が主因」を優先。',
    quickBundle: [
      '固定シフト優先と残業上限の設定',
      '夜勤・連続勤務の除外条件を明文化',
