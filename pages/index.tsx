      ...
      <section id="vision" data-testid="vision" className="mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-5 gap-8 items-start">
        ...
        <div className="md:col-span-3 grid gap-4">
          <div className="rounded-2xl border p-5 shadow-sm bg-white">
            <h3 className="font-medium mb-1">H1（いま）— 公平な働き方を設計する</h3>
            <p className="text-gray-700 text-sm">合理的配慮を科学し、提案→申請→実装→KPIを一筆書きにする（JAC／Playbook）。</p>
          </div>
          <div className="rounded-2xl border p-5 shadow-sm bg-white">
            <h3 className="font-medium mb-1">H2（2026–2029）— 人間＋AIの共同行為</h3>
            <p className="text-gray-700 text-sm">協調エージェントが日々の仕事・学び・ケアを共同設計。個人は“存在の物語”で価値創出。</p>
          </div>
          <div className="rounded-2xl border p-5 shadow-sm bg-white">
            <h3 className="font-medium mb-1">H3（2030+）— Next Being Commons</h3>
            <p className="text-gray-700 text-sm">公共圏に開かれた支援・学習・労働のコモンズ化。評価は尊厳・貢献・持続可能性の三軸。</p>
          </div>
          <div className="rounded-2xl border p-5 shadow-sm bg-white">
