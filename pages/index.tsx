    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur" data-testid="top-nav">
        <div className="mx-auto max-w-7xl px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="#phase1" className="hover:opacity-80">
              NBL（Phase 1）
            </a>
      ...
      >
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <strong className="font-semibold">転回点</strong>が来ると言われます。
            NBLはこの前後を跨いで、
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <article className="rounded-2xl border p-5 shadow-sm bg-white">
              ...
              <div className="mt-2 text-[11px] text-gray-500">
                AGIは補助輪。ハンドルは人に。—{' '}
                <span className="font-semibold">Human-in-Command</span>
              </div>
            </article>
      ...
      >
        <div className="md:col-span-2">
          ...
          <p className="text-gray-700 leading-relaxed">
            Next Being
            Lab（NBL）は、人×AI×コミュニティが共創する次の社会に向けた研究・実装ラボです。 Phase
          ...
          <div className="rounded-2xl border p-5 shadow-sm bg-white">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <article className="rounded-xl border p-4 bg-white">
                ...
                <a href="#product" className="text-sm underline">
                  JACを見る
                </a>
              </article>
              ...
              <article className="rounded-xl border p-4 bg-white">
                ...
                <a href="#phase1" className="text-sm underline">
                  概要
                </a>
              </article>
              ...
              <article className="rounded-xl border p-4 bg-white">
                ...
                <a href="#campaign" className="text-sm underline">
                  キャンペーン
                </a>
              </article>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <p className="text-gray-700">
              診断名ではなく <span className="font-semibold">タスク条件 × 症状像</span>{' '}
              で配慮を設計。 設計→合意→実装→KPIを一筆書きで回し、調整後の実力（Design-Adjusted
              Merit）で評価します。 主役は人、AIは
              <span className="whitespace-nowrap"> 可視化・最適化・安全装置 </span>を担う
      ...
      <section id="poc" data-testid="poc" className="mx-auto max-w-7xl px-6 py-16">
        ...
        <p className="text-gray-700 mb-5">
          小さく早く検証して、<span className="font-semibold">“できる”を証明</span>
          する短期プロジェクトです。 NBLの{' '}
          <span className="font-semibold">JAC（Job Accommodation Copilot）</span> と
          <span className="font-semibold">Accommodation Playbook</span> を使い、
          <span className="whitespace-nowrap">提案→申請→実装→KPI</span>{' '}
          を2〜4週間で一筆書きに回します。
        </p>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-6">
          ...
          <p className="text-gray-700 mb-5 text-sm">
            実施規模・対象人数・データ連携の有無などで変動します。ここは「目安」です。 詳細は{' '}
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border p-5 bg-white shadow-sm">
              ...
              <p className="text-sm text-gray-700 mt-2">
                ...
                <br />
                <span className="text-gray-600 text-xs">
                  価格レンジ：<span className="italic">要相談</span>
                </span>
              </p>
            </div>
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          ...
          <a className="rounded-2xl px-4 py-2 border shadow-sm" href="#contact">
            フォームで連絡
          </a>
          <a
      ...
      <section id="market" className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="rounded-3xl border bg-white shadow-sm p-6">
          ...
          <div className="mt-8 text-sm text-gray-700 leading-relaxed">
            <p>
              NBLは、これら三層の交点に立ち、
              <span className="font-semibold">“AI×包摂”を社会インフラ化</span>する
              実証と標準化のラボです。
            </p>
            <p className="mt-2">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a
              href="/docs/NBL_InclusionTech_Market_Brief.pdf"
      ...
      >
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="/docs/Accommodation_Case_Deck.pdf"
              className="rounded-xl px-4 py-2 border text-sm"
            >
              事例スライド（準備中）
            </a>
          ...
          <p className="sr-only">
            「CAN BY
            DESIGN」は、合理的配慮を標準機能として設計し、合意・実装・KPIまで一貫して運用するキャンペーンです。
          </p>
        </div>
      </section>
      ...
      <footer className="border-t">
        <div className="mx-auto max-w-7xl px-6 py-10 grid md:grid-cols-4 gap-6 items-start text-sm text-gray-600">
          ...
          <div className="flex flex-col gap-1">
            ...
            <a className="underline" href="#phase1">
              NBL（Phase 1）
            </a>
