          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div>
              ...
              <p className="text-gray-700">
                ...
                設計→合意→実装→KPIを一筆書きで回すことで、
                職務遂行の実力（Design-Adjusted Merit）を正しく評価できます。
                主体は人、AIは可視化・最適化・安全装置を担う <span className="whitespace-nowrap">Human-in-Command</span>。
              </p>
