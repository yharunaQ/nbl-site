...
- Campaign: 次の地平へ
- Title: 腹ペコのまま
- Folder: `content-inbox/songs/次の地平へ/腹ペコのまま`
- Audio files:
  - `腹ペコのまま.wav`
- Status: hold
...
- Short concept note (120-200 chars): Steve Jobsの伝説のスピーチを70年代風の歌に。
...
レコードの傷さえ　ビートに変えて  
さあ跳ねる鼓動で　世界を再起動  
Stay hungry, stay foolish — 愛を込めて
```
