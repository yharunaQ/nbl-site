...
export const jacFoundationsHero = {
  eyebrow: 'JAC Foundations',
  headline: 'JAC 26フレームは、困りごとを診断名ではなく、反復する職場課題の型として捉えるための地図です。',
  subheadline:
    'ここでは、JAC 26フレームの全体像である 3レイヤー と、その背景にある基礎図解を、企業担当者にも読みやすい形で紹介します。個別事情を飛ばして結論を出すためではなく、職場設計の見立てをそろえるための入口です。',
  audience:
...
export const jacFoundationTakeaways: JacFoundationTakeaway[] = [
  ...
  {
    title: 'JACの見立て方',
    detail: '診断名から結論を急ぐのではなく、仕事・環境・支援・時間の条件をそろえて考える姿勢が分かります。',
  },
  {
    title: '企業側の最初の論点',
    detail: '合理的配慮、継続就労、相談導線を、個別善意ではなく職場設計として捉える視点が持てます。',
  },
];
...
export const jacFoundationLayers: JacFoundationLayer[] = [
  {
    ...
    imageSrc: '/jac-foundations/health-layer.png',
    imageAlt: 'JAC 26フレーム 体調レイヤー一覧',
  ...
  },
  {
    ...
    imageSrc: '/jac-foundations/transition-layer.png',
    imageAlt: 'JAC 26フレーム 就職移行レイヤー一覧',
  ...
  },
  {
    ...
    imageSrc: '/jac-foundations/operation-layer.png',
    imageAlt: 'JAC 26フレーム 職場運用レイヤー一覧',
...
export const jacFoundationInfographics: JacFoundationInfographic[] = [
  ...
  },
  {
    ...
    whatItAdds:
      'JAC の見立てが「人の問題」だけに偏らないための補助線です。体調、仕事、環境、支援の相互作用を見る視点を支えます。',
    businessMeaning:
      '相談や面談の場で論点が症状説明だけに寄らず、仕事の条件や環境の見直しまで広がる助けになります。',
    imageSrc: '/jac-foundations/condition-map.png',
    imageAlt: '仕事のコンディションマップ',
  },
  {
    title: '障害者雇用の質の指標',
    summary:
      '雇用率だけでなく、継続性、相談のしやすさ、仕事設計、支援連携の質として障害者雇用を見るための基礎図解です。',
    whatItAdds:
      'JAC を単なる個別対応ツールではなく、職場の設計品質を見る枠組みとして位置づけやすくします。',
    businessMeaning:
      '採用件数だけを追うのではなく、辞めなくて済む設計や相談しやすい導線を評価対象に含める視点につながります。',
    imageSrc: '/jac-foundations/quality-metrics.png',
    imageAlt: '障害者雇用の質の指標',
  },
];
