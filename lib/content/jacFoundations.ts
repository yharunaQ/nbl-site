...
export const jacFoundationPathwayIntro = {
  ...
  summary:
    '3レイヤーの全体像を掴んだら、26フレームの早見表でフレームごとの詳細を確認できます。インタラクティブガイドでは困りごとのタグで絞り込みながら探索でき、配慮設計アシストツールでは個別ケースの仮見立てと配慮候補を自動整理します。',
};
...
export const jacFoundationPathwaySteps: JacFoundationPathwayStep[] = [
  {
    ...
    status: '公開中',
    detail:
      '3レイヤーと 26フレームの全体像を共有し、困りごとを診断名だけでなく仕事設計の課題として読む共通地図です。',
    businessMeaning:
  ...
  },
  {
    ...
    status: '公開中',
    detail:
      '各フレームの使いどころ、状況レベル、最初の取組みポイントを早見表で確認できます。インタラクティブガイドでは困りごとのタグで絞り込みながら探索できます。',
    businessMeaning:
      '地図だけでは浅い読者が、個別判断へ飛ぶ前にフレームの読み方と最初の取組みを確認できます。',
    routeNote: '早見表とインタラクティブガイドの2つで詳細確認できます。',
    href: '/jac/frames',
    cta: '26フレーム早見表を見る',
  },
  {
    ...
    status: '招待制・無償',
    detail:
      '相談内容を入力すると、職業的課題の仮見立てと配慮候補の優先順位を自動整理します。就労支援員・ジョブコーチ向けのAI補助ツールです。',
    businessMeaning:
      '典型パターンの確認を終えた後、個別ケースの条件整理を数分でドラフトできます。',
    routeNote: '職種・メールアドレスで申込後、個人単位のアクセストークンをお送りします。アセスメント実行は1日20件までです。',
    href: '/jac/intro',
    cta: 'ツール詳細・申込を見る',
  },
];
...
export const jacFoundationPathwaySupport: JacFoundationPathwaySupport = {
  title: 'このガイドの使い方と限界',
  detail:
    '見取り図と 26フレームは全体地図であり、個別ケースの最終判断を自動で返すものではありません。個別化が必要なときは、本人・仕事・環境・支援・時間・制度の条件を重ねて確認してください。',
  bullets: [
